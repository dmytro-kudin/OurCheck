...
using OurCheck.Features.Appointment.Commands.Create;
using OurCheck.Features.Appointment.Commands.Delete;
using OurCheck.Features.Appointment.Queries.Get;
using OurCheck.Features.Appointment.Queries.List;
...
public class AppointmentController(ISender mediatr) : ControllerBase
{
    ...
    [HttpPost]
    public async Task<IResult> CreateTask([FromBody] CreateAppointmentCommand command)
    {
